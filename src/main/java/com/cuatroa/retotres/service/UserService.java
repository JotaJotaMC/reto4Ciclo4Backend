...
// permite actualizar los campos del usuario consultando por id
...
//Elimina el usuario ubicándolo por el ID
    ...
    public boolean emailExists(String email) {
        //verifica si el correo electrónico existe para validar el ingreso o creación de cuenta
        return userRepository.emailExists(email);
    }

    public User authenticateUser(String email, String password) {

//Autenticación del usuario con su correo y contraseña
